...
describe('EntriesList', () => {
    const mockEntries = [
        { id: 1, date: '2024-01-15', index: 1, content: 'First entry', tags: ['work', 'important'] },
        { id: 2, date: '2024-01-15', index: 2, content: 'Second entry', tags: ['personal'] },
        { id: 3, date: '2024-01-14', index: 1, content: 'Third entry', tags: ['ideas'] }
    ];
