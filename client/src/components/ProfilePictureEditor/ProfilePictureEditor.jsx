...
function ProfilePictureEditor({ isOpen, onClose, onSave, currentImage, t, isDark }) {
    ...
    const handleSave = () => {
        ...
        // The preview container is CANVAS_SIZE x CANVAS_SIZE
        ...
        if (imgAspect > 1) {
            // Wider than tall - height fills container
            displayHeight = containerSize;
            displayWidth = containerSize * imgAspect;
        } else {
            // Taller than wide - width fills container
