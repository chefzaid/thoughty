...
export const translations: Translations = {
  en: {
    ...
    semanticSearchCount:
      "Closest matches: {matches}. Entries analyzed: {analyzed}.",
    ...
    highContrastDescription:
      "Increase outlines and contrast across the app for easier reading.",
    fontPreview: "Preview",
    fontPreviewDescription:
      "Check how your chosen type, size, and color look together before saving.",
    fontPreviewKicker: "Sample entry",
    fontPreviewSample:
      "Quiet details become easier to notice when the page matches how you like to read and write.",
    ttsVoice: "Voice for read aloud",
    ttsVoiceDescription:
      "Choose which voice Thoughty uses when reading entries aloud.",
    ...
    ttsVoicePreviewSample:
      "This is how your journal will sound when Thoughty reads it aloud.",
    ...
    twoFactorEnabledDescription:
      "A code sent to your verified email is required when you sign in.",
    twoFactorDisabledDescription:
      "Add an email verification code after your password for stronger account security.",
    twoFactorPasswordAccountsOnly:
      "Email codes are available for password accounts only.",
    twoFactorVerifyEmailFirst:
    ...
    toneMix: "Tone Mix",
    toneMoodUnavailable:
      "AI analysis is unavailable right now. Configure AI settings and try again later.",
    subjectsDiscussed: "Subjects Discussed",
    subjectsDiscussedDescription:
      "AI grouping of the recurring subjects in your recent entries.",
    subjectsDiscussedUnavailable:
      "Subject analysis is unavailable right now. Configure AI settings and try again later.",
    ...
    personalityAnalysisError:
      "Writing analysis could not be completed. Please try again.",
    personalityUnavailable:
      "Writing analysis is unavailable for this selection.",
    personalityPrivacy:
      "Your raw entries stay on this server. AI receives aggregate word and subject statistics only.",
    personalityDisclaimer:
      "These non-clinical tendencies reflect writing patterns, not your identity or a diagnosis.",
    lessActivity: "Less",
    moreActivity: "More",
    ...
    export: "Export",
    exportDescription:
      "Download all journal entries from {diaryName} in the format of your choice.",
    ...
    importing: "Importing...",
    importSuccess:
      "Successfully imported {imported} entries ({skipped} duplicates skipped)",
    ...
    bookNoChapters:
      "No chapters could be built. Add tags to your entries to create chapters.",
    ...
    bookCloudConnectHint:
      "Connect a cloud provider in your profile to upload books.",
    ...
    bookVersionEmpty:
      "Save a version to preserve this book and track future updates.",
    ...
    landingProofInsightLabel:
      "Structure, stats, imports, and exports respect each journal",
    landingScreenshotsKicker: "Product screenshots",
    landingScreenshotsHeading:
      "The main workflows are visible before you sign up.",
    landingScreenshotAlt: "Thoughty journal interface preview",
    landingSceneEntryTitle: "Morning planning",
    landingSceneEntryBody:
      "Two decisions to remember, one question to revisit, and a cleaner way to end the week.",
    ...
    aboutMissionTitle:
      "Make personal writing easier to keep, revisit, and trust.",
    ...
    duplicateScanDescription:
      "Review high-confidence matches before deciding whether to remove an entry.",
    scanningDuplicates: "Comparing recent entries...",
    duplicateScanError:
      "Unable to compare entries. Check your OpenRouter API key and try again.",
    noDuplicatesFound: "No high-confidence duplicates were found.",
    duplicateScanCount: "Analyzed {analyzed} of {total} entries.",
    duplicateScanLimited:
      "Only the 40 newest entries were analyzed. Select a diary to narrow the scan.",
    ...
    aiChatError:
      "Unable to get a response. Check your OpenRouter API key and try again.",
    ...
    noHighlights:
      "No highlights available yet. Start writing entries to see them here!",
    ...
    aiUnavailable: "No API key available",
    ...
    apiKeyRemoveError: "Could not remove API key",
    createOpenRouterKey: "OpenRouter keys",
    usageDashboard: "Usage dashboard",
    refreshUsage: "Refresh usage",
    thoughtyUsagePeriod: "Thoughty activity over the last {days} days",
    totalTokens: "Total tokens",
    promptTokens: "Prompt tokens",
    completionTokens: "Completion tokens",
    reasoningTokens: "Reasoning tokens",
    requests: "Requests",
    thoughtyCost: "Thoughty cost",
    openRouterKeyUsage: "OpenRouter key usage",
    allTimeCost: "All-time spend",
    monthlyCost: "This month",
    dailyCost: "Today",
    remainingLimit: "Limit remaining",
    unlimited: "Unlimited",
    usageUnavailable: "Usage is temporarily unavailable",
    openRouterModel: "Model",
    openRouterTaskModels: "Task-specific models",
    openRouterTaskModelsDescription:
      "Optional overrides for AI tasks. Leave blank to use the default model above.",
    ...
    cloudSyncDescription:
      "Connect to Google Drive or OneDrive to sync your exported journal files to the cloud.",
    ...
    cloudScheduleDescription:
      "Automatically sync your journal to the cloud on a fixed schedule. Only changes since the last sync are detected — no redundant uploads.",
    ...
    cloudProvidersDescription:
      "Connect your cloud storage accounts to enable syncing and importing files.",
    ...
    subscriptionPlanDescription:
      "Choose the subscription tier saved for this account",
    ...
    subscriptionPaymentMethodDescription:
      "Store the payment method label shown in billing records",
  ...
  fr: {
    ...
    semanticSearchCount:
      "Résultats proches : {matches}. Entrées analysées : {analyzed}.",
    semanticSearchLimited:
      "Seules les 100 entrées les plus récentes ont été analysées.",
    ...
    fontSizeDescription:
      "Ajustez la taille de texte de base utilisée dans l’application",
    fontColor: "Couleur du texte",
    fontColorDescription:
      "Définissez une couleur de texte préférée pour votre interface",
    highContrast: "Contraste élevé",
    highContrastDescription:
      "Renforce les contours et le contraste dans l'application pour faciliter la lecture.",
    fontPreview: "Aperçu",
    fontPreviewDescription:
      "Vérifiez l’ensemble police, taille et couleur avant d’enregistrer.",
    fontPreviewKicker: "Exemple de note",
    fontPreviewSample:
      "Les détails calmes deviennent plus faciles à voir quand la page correspond à votre façon de lire et d’écrire.",
    ttsVoice: "Voix de lecture",
    ttsVoiceDescription:
      "Choisissez la voix que Thoughty utilise pour lire les entrées à voix haute.",
    ...
    ttsVoicePreviewSample:
      "Voici comment votre journal sonnera lorsque Thoughty le lira à voix haute.",
    ...
    twoFactorEnabledDescription:
      "Un code envoyé à votre email vérifié est requis lors de la connexion.",
    twoFactorDisabledDescription:
      "Ajoutez un code de vérification par email après votre mot de passe.",
    twoFactorPasswordAccountsOnly:
      "Les codes par email sont réservés aux comptes avec mot de passe.",
    twoFactorVerifyEmailFirst:
      "Vérifiez votre email avant d'activer l'authentification à deux facteurs.",
    ...
    twoFactorVerificationFailed:
      "Le code de vérification n'a pas pu être confirmé.",
    twoFactorResendFailed: "Le nouveau code n'a pas pu être envoyé.",
    twoFactorRequestFailed:
      "La demande d'authentification à deux facteurs a échoué.",
    ...
    emailVerificationInvalid:
      "Ce lien de vérification n'est pas valide ou a expiré.",
    ...
    toneMoodUnavailable:
      "L'analyse IA est indisponible pour le moment. Configurez l'IA puis réessayez plus tard.",
    subjectsDiscussed: "Sujets abordés",
    subjectsDiscussedDescription:
      "Regroupement par IA des sujets récurrents dans vos entrées récentes.",
    subjectsDiscussedUnavailable:
      "L'analyse des sujets est indisponible pour le moment. Configurez l'IA puis réessayez plus tard.",
    ...
    personalityAnalysisError:
      "L'analyse de l'écriture n'a pas pu aboutir. Veuillez réessayer.",
    personalityUnavailable:
      "L'analyse de l'écriture est indisponible pour cette sélection.",
    personalityPrivacy:
      "Vos entrées brutes restent sur ce serveur. L'IA ne reçoit que des statistiques agrégées sur les mots et les sujets.",
    personalityDisclaimer:
      "Ces tendances non cliniques reflètent des habitudes d'écriture, et non votre identité ou un diagnostic.",
    lessActivity: "Moins",
    moreActivity: "Plus",
    ...
    importDescription:
      "Téléversez un fichier texte pour importer des entrées dans {diaryName}.",
    ...
    importSuccess:
      "{imported} entrées importées avec succès ({skipped} doublons ignorés)",
    ...
    bookChapterFraming:
      "Ajouter des introductions et résumés de chapitre par IA",
    ...
    bookNoChapters:
      "Aucun chapitre n'a pu être créé. Ajoutez des tags à vos entrées pour créer des chapitres.",
    ...
    bookCloudConnectHint:
      "Connectez un fournisseur cloud dans votre profil pour téléverser des livres.",
    ...
    bookVersionEmpty:
      "Enregistrez une version pour conserver ce livre et suivre ses futures mises à jour.",
    bookVersionNumber: "Version {version}",
    bookVersionCounts: "{chapters} chapitres · {entries} entrées",
    bookVersionChanges:
      "{entries} nouvelles entrées · {chapters} nouveaux chapitres",
    ...
    formatDescription:
      "Personnalisez le format du fichier texte pour l'import et l'export.",
    ...
    landingProofInsightLabel:
      "Structure, stats, imports et exports respectent chaque journal",
    landingScreenshotsKicker: "Aperçus du produit",
    landingScreenshotsHeading:
      "Les principaux usages sont visibles avant l'inscription.",
    landingScreenshotAlt: "Aperçu de l'interface du journal Thoughty",
    landingSceneEntryTitle: "Plan du matin",
    landingSceneEntryBody:
      "Deux décisions à garder, une question à reprendre, et une meilleure façon de finir la semaine.",
    ...
    landingCtaTitle:
      "Ouvrez un journal que vous pourrez garder pendant des années.",
    landingCtaBody:
    ...
    aboutMissionKicker: "Mission",
    aboutMissionTitle:
      "Rendre l’écriture personnelle plus facile à garder, relire et faire confiance.",
    ...
    feedbackEmpty:
      "Aucune idée pour le moment. Soyez la première personne à en proposer une.",
    feedbackSubmitError:
      "Votre idée n'a pas pu être envoyée. Veuillez réessayer.",
    feedbackVoteError:
    ...
    summaryIncludeDetailsPlaceholder:
      "Détails ou sujets facultatifs à souligner",
    ...
    duplicateScanDescription:
      "Examinez les correspondances fiables avant de supprimer une entrée.",
    scanningDuplicates: "Comparaison des entrées récentes...",
    duplicateScanError:
      "Impossible de comparer les entrées. Vérifiez votre clé API OpenRouter et réessayez.",
    ...
    duplicateScanLimited:
      "Seules les 40 entrées les plus récentes ont été analysées. Sélectionnez un journal pour affiner la recherche.",
    ...
    aiChatError:
      "Impossible d'obtenir une réponse. Vérifiez votre clé API OpenRouter et réessayez.",
    ...
    aiUnavailable: "Aucune clé API disponible",
    openRouterKeyPlaceholder: "sk-or-v1-...",
    ...
    apiKeySaveError: "Impossible d'enregistrer la clé API",
    apiKeyRemoveError: "Impossible de supprimer la clé API",
    createOpenRouterKey: "Clés OpenRouter",
    usageDashboard: "Tableau d'utilisation",
    refreshUsage: "Actualiser l'utilisation",
    thoughtyUsagePeriod: "Activité Thoughty des {days} derniers jours",
    totalTokens: "Total de tokens",
    promptTokens: "Tokens d'entrée",
    completionTokens: "Tokens de réponse",
    reasoningTokens: "Tokens de raisonnement",
    requests: "Requêtes",
    thoughtyCost: "Coût Thoughty",
    openRouterKeyUsage: "Utilisation de la clé OpenRouter",
    allTimeCost: "Dépenses totales",
    monthlyCost: "Ce mois-ci",
    dailyCost: "Aujourd'hui",
    remainingLimit: "Limite restante",
    unlimited: "Illimitée",
    usageUnavailable: "L'utilisation est temporairement indisponible",
    openRouterModel: "Modèle",
    openRouterTaskModels: "Modèles par tâche",
    openRouterTaskModelsDescription:
      "Remplacements facultatifs pour les tâches IA. Laissez vide pour utiliser le modèle par défaut ci-dessus.",
    openRouterTagModel: "Tags",
    ...
    cloudSyncDescription:
      "Connectez-vous à Google Drive ou OneDrive pour synchroniser vos fichiers journal exportés vers le cloud.",
    ...
    cloudScheduleDescription:
      "Synchronisez automatiquement votre journal vers le cloud selon un calendrier fixe. Seuls les changements depuis la dernière synchronisation sont détectés.",
    ...
    cloudProvidersDescription:
      "Connectez vos comptes de stockage cloud pour activer la synchronisation et l'importation de fichiers.",
    cloudImportFromCloud: "Importer depuis le Cloud",
    cloudSelectFileToImport:
      "Sélectionnez un fichier de votre stockage cloud à importer",
    subscriptionManagement: "Abonnement",
    subscriptionCurrentPlan: "Offre actuelle",
    subscriptionPlan: "Offre",
    subscriptionPlanDescription:
      "Choisissez le niveau d'abonnement enregistré pour ce compte",
    ...
    subscriptionPaymentMethodDescription:
      "Enregistrez le libellé du moyen de paiement affiché dans la facturation",
